package com.jkpdev.dummyproject.player;
...
import com.jkpdev.dummyproject.R;
import com.jkpdev.dummyproject.dtpv.DoubleTapPlayerView;
import com.jkpdev.dummyproject.dtpv.youtube.YouTubeOverlay;
...
////        Uri videouri = Uri.parse("https://soultribenow.com/storage/app/public/images/127/stories/1655960381MP4_20220623_102934.mp4.mp4");
//        Uri videouri = Uri.parse("http://techslides.com/demos/sample-videos/small.ogv");
//        mPrefs.setPersistent(true);
//        mPrefs.updateMedia(this, videouri, "mp4");
//
//        Uri captionuri = Uri.parse("https://bulir.devtechnosys.tech:17332/upload/user/Tubelight.srt");
//        SubtitleUtils.clearCache(this);
//        Uri captionuri2 = SubtitleUtils.convertToUTF(this, captionuri);
//        mPrefs.updateSubtitle(captionuri2);


        if ("com.jkpdev.dummyproject.player.action.SHORTCUT_VIDEOS".equals(action)) {
    ...
    private void enterPiP() {
        ...
        if (format != null) {
            ...
            if (Build.VERSION.SDK_INT >= 33 &&
                    getPackageManager().hasSystemFeature(FEATURE_PICTURE_IN_PICTURE) &&
